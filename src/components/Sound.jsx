...
const Modal = ({ onClose, toggle }) => {
  return createPortal(
    <div className="z-30 fixed inset-0 bg-background/60 backdrop-blur-sm flex items-center justify-center">
...
const Sound = () => {
  ...
  const toggle = () => {
    ...
    setShowModal(false)
    /**
     * Now what if the user has already the consent as true and when reload the page, it should start playing music. But it will not work, since the browser
     * will not autoplay the music, unless you interact with the website, so how will we know that the user has interacted or not, so we use useEffect to detect that.
     */
  };
...
/**
 * This component can be used anywhere, it has all the things needed, it can be used for different type of popups such as cookies and everything...
 */